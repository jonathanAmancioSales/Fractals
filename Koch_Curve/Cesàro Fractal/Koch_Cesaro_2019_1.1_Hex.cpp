//===========================================
// Name        : Koch_Cesaro_2019_1.1_Hex.cpp
...
vector< Tripleto > Hexagono(Par O, float L, float angle){
	vector< Tripleto > list;
	float x,y;
	for(int i=0; i<=6; i++)
...
int main(int argc, char* argv[]){
	...
	bool save_all=1;	//0->Salvar apenas a ultima iteracao; 1->Salvar todas;
